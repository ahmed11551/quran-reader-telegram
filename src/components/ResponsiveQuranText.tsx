...
export const ResponsiveQuranText: React.FC = () => {
  ...
  if (!currentSurahData || !currentAyahData) {
    return (
      <motion.div 
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        className="bg-white rounded-xl md:rounded-2xl shadow-xl p-6 md:p-8 text-center"
      >
      ...
      <div className="p-4 md:p-6">
        ...
        >
          <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl md:rounded-2xl p-4 md:p-8 text-center">
            <div className="text-2xl md:text-4xl leading-relaxed font-amiri text-gray-900 mb-3 md:mb-4">
              ...
              <div className="bg-gray-50 rounded-xl md:rounded-xl p-4 md:p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4">
                  {currentAyahData.words.map((word, index) => (
                    ...
                    >
                      <div className="text-right text-lg md:text-xl font-amiri text-gray-900 mb-2">
                        {word.text}
                      </div>
